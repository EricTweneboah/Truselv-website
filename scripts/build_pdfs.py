...
pdf('tess-product-brief.pdf','TESS. More moments that matter.','Therapeutic Engagement and Support System — a welcoming tablet experience for communication, entertainment and shared engagement.',[
 ...
 ('The tablet offer',[f'The advertised base offer is £{config["tessUnitPrice"]} for one tablet with 12 months of TESS Premium included.',escape(config['bundleStatement']),escape(config['vatStatement']+' '+config['deliveryStatement']),escape(config['premiumRenewalStatement'])]),
 ('Your own tablet',['The TESS app is intended for compatible iPad and Android tablets with a free download. Ask for current store availability, minimum operating-system requirements and the features included in the free and Premium plans. This website does not yet publish verified store listings.']),
 ...
 ('Before you order',['An order enquiry is not a purchase, reservation or subscription. Confirm the legal seller, exact specification, full payable price, delivery, Premium activation/renewal and cancellation terms before payment. Product photography is illustrative; it is not a contractual accessory list.'])])
...
pdf('truselv-company-overview.pdf','The person beyond the diagnosis.','TruSelv develops human-centred digital healthcare experiences through two flagship products: Bedbord and TESS.',[
 ...
 ('TESS',['An approachable tablet experience for communication, games, entertainment, reminiscence and radio. The advertised tablet offer is £120 with 12 months of Premium; final sale details must be confirmed before purchase.']),
